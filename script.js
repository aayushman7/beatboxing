document.addEventListener('keydown',(event)=>{
  ...
  if (key==65){
    ...
    document.getElementById('65').style.backgroundColor="aqua";
      document.getElementById('65').style.boxShadow="0px 0px 10px 0px aqua";
    setTimeout(function(){
  ...
  if (key==83){
    ...
    document.getElementById('83').style.backgroundColor="aqua";
      document.getElementById('83').style.boxShadow="0px 0px 10px 0px aqua";
    setTimeout(function(){
  ...
  if (key==68){
    ...
    document.getElementById('68').style.backgroundColor="aqua";
      document.getElementById('68').style.boxShadow="0px 0px 10px 0px aqua";
    setTimeout(function(){
  ...
  if (key==70){
    ...
    document.getElementById('70').style.backgroundColor="#ff00ff";
      document.getElementById('70').style.boxShadow="0px 0px 10px 0px #ff00ff";
    setTimeout(function(){
  ...
  if (key==71){
    ...
    document.getElementById('71').style.backgroundColor="#ff00ff";
      document.getElementById('71').style.boxShadow="0px 0px 10px 0px #ff00ff";
    setTimeout(function(){
  ...
  if (key==72){
    ...
    document.getElementById('72').style.backgroundColor="#ff00ff";
      document.getElementById('72').style.boxShadow="0px 0px 10px 0px #ff00ff";
    setTimeout(function(){
  ...
  if (key==74){
    ...
    document.getElementById('74').style.backgroundColor="#ff00ff";
      document.getElementById('74').style.boxShadow="0px 0px 10px 0px #ff00ff";
    setTimeout(function(){
  ...
  if (key==75){
    ...
    document.getElementById('75').style.backgroundColor="white";
      document.getElementById('75').style.boxShadow="0px 0px 10px 0px white";
    setTimeout(function(){
  ...
  if (key==76){
    ...
    document.getElementById('76').style.backgroundColor="white";
      document.getElementById('76').style.boxShadow="0px 0px 10px 0px white";
    setTimeout(function(){
